...
const ContactMe = () => {
  return (
    <div
      id="contact"
      className="py-6 text-center text-white bg-purple-400"
    ...
    >
      ...
      <div>
        <span
          ...
          onClick={() => (window.location.href = "tel:07033098551")}
        >
          <span className="mr-2">
      ...
      <div className="flex justify-center ">
        ...
        >
          ...
          <a
            rel="noopener noreferrer"
            target="_blank"
            href="https://twitter.com/sambalicious_sa"
          >
            <FaTwitter />
          </a>
          <a
      ...
      <div className="flex justify-end mb-8">
        {" "}
        <FloatingButton action={() => scroll.scrollToTop()} />{" "}
      </div>

      <div className="flex justify-between">
        <div className="flex justify-start ml-4 text-xs text-white">
          Mockup design by Esther Ilori
        </div>

        <div className="flex justify-end mr-6 text-xs text-white">
